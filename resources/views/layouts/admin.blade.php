...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">GoZibil</div>
        </a>
        ...
        <!-- Nav Item - RBigTrash -->
        <li class="nav-item {{ Nav::isRoute('rbigtrash') }}">
            <a class="nav-link" href="{{ route('rbigtrash') }}">
                <i class="fas fa-fw fa-trash"></i>
                <span>{{ __('R-BigTrash') }}</span>
            </a>
        </li>

        <!-- Nav Item - Artikel -->
        <li class="nav-item {{ Nav::isRoute('artikel') }}">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; GoZibil 2021</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
